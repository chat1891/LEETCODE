...
|num|Question| Category | Difficulty | Solution |Like|
|---| ------ | -------- | ---------- | -------- | -- |
|1| [Two Sum](https://leetcode.com/problems/two-sum/) |Arrays|Easy|[C++](./Arrays/1_TwoSum.cpp)|
|11| [Container With Most Water](https://leetcode.com/problems/container-with-most-water/) |Arrays, two pointers|Medium|[C++](./Arrays/11_ContainerWithMostWater.cpp)|
|15| [3Sum](https://leetcode.com/problems/3sum/) |Arrays, two pointers|Medium|[C++](./Arrays/15_3Sum.cpp)|
...
|152| [Maximum Product Subarray](https://leetcode.com/problems/maximum-product-subarray/) |Arrays,dp|Medium|[C++](./Arrays/152_MaximumProductSubarray.cpp)|
...
|217| [Contains Duplicate](https://leetcode.com/problems/contains-duplicate/) |Arrays|Easy|[C++](./Arrays/217_ContainsDuplicate.cpp)|
|238| [Product of Array Except Self](https://leetcode.com/problems/product-of-array-except-self/) |Arrays|Medium|[C++](./Arrays/238_ProductofArrayExceptSelf.cpp)|
|||||||
